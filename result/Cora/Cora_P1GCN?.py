...
class P1GCN(torch.nn.Module):
    def __init__(self, hidden_channels, reduction_type):
        ...
        self.conv1 = ConvolutionalLayer1(dataset.num_features, hidden_channels, 1)
        self.conv2 = ConvolutionalLayer1(hidden_channels, hidden_channels,  2)
        self.conv3 = ConvolutionalLayer1(hidden_channels, hidden_channels,  3)
        self.conv4 = ConvolutionalLayer1(hidden_channels, dataset.num_classes,  4)
